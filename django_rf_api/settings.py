"""
Django settings for django_rf_api project.
...
SECRET_KEY = 'django-insecure-p$kjlz_1*it5ia-@xvkc@q+kb)tmp+@t=@e@^g&k#m1*a8-)if'
...
ROOT_URLCONF = 'django_rf_api.urls'
...
WSGI_APPLICATION = 'django_rf_api.wsgi.application'
